    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 container mx-auto px-12 py-20 text-center">
        <div className="max-w-6xl mx-auto">
          {/* Main Heading */}
          <h1 id="hero-name-shimmer" className="text-6xl md:text-8xl lg:text-9xl mb-8 tracking-tight leading-[1.1] animate-fade-in" style={{ fontFamily: "'Cormorant Garamond', 'Garamond', Georgia, serif" }}>
